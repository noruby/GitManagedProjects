...
%\begin{eqnarray}
%<n{\bf k}|[\hat{\bf p},\hat{\rho}]|n'{\bf k'}>&=& \frac{m}{i \hbar}<n{\bf k}|[[\hat{\bf x}, \hat{H}_0],\hat{\rho}]|n'{\bf k'}> \nonumber \\
%&=&\frac{m}{i \hbar}  \sum_{n''} \int dk'' <nk|[\hat{\bf x}, \hat{H}_0]|n''k''><n''k''|\hat{\rho}|n'k'> - <nk|\hat{\rho}|n''k''><n''k''|[\hat{\bf x}, \hat{H}_0]|n'k'>) \nonumber \\
%\end{eqnarray} 
