...
\end{eqnarray}
where $\epsilon'<0$ holds at our operating frequency $\omega$. %where $\epsilon' \simeq -\omega_p^2/(\omega^2+\omega_p^2)$ is used to derive the second line.
...
%The reason why $L_{\mathrm{SPP}}$ increases with decreasing $\omega_{\tau}$ will be described in the following. 
